<x-app-layout>
    <x-slot name="header">
        <div>
            <h1 class="text-2xl font-semibold tracking-tight text-zinc-950">Tambah Pinjaman</h1>
            <p class="mt-1 text-sm leading-6 text-zinc-500">Input pengajuan, plafon, tenor, dan status pinjaman.</p>
        </div>
    </x-slot>
