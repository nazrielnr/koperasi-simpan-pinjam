                    ...
                    <tr class="transition hover:bg-zinc-100/60">
                        ...
                        <td class="px-3 py-3">
                            <div class="flex justify-end gap-3">
                                <a href="{{ route('anggota.show', $item) }}" class="text-xs font-medium text-zinc-600 transition hover:text-zinc-950">Detail</a>
                                <a href="{{ route('anggota.edit', $item) }}" class="text-xs font-medium text-zinc-600 transition hover:text-zinc-950">Edit</a>
